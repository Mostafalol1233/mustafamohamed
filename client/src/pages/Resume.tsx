              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="mt-2.5 space-y-1.5 text-sm text-gray-600 list-none">
                    ...
                    <li className="flex gap-2"><span className="text-blue-500 mt-0.5">▸</span>Built and maintains Bemora (npmjs.com/package/bemora) — an open-source package providing a unified interface to 94+ public APIs (weather, crypto, AI, gaming, and more).</li>
